...
<body>
<form action="tabel.php" method="get" enctype="multypart/form-data">
<div class="container">
<h2>Login Form</h2>
<form>
...
<input type="password" name="fpassword" id="password" placeholder="Enter your password" required>
</div>
<div class="new"><a href="register.php">buat akun baru</a></div>
